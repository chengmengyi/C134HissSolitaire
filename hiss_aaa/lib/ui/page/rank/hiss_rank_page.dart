              ...
              Align(
                ...
                child: Row(
                  children: [
                    ...
                    ClipRRect(
                      borderRadius: BorderRadius.circular(10.w),
                      child: HissImagesWidget(name: aMyHead.getData(), width: 40.w, height: 40.w),
                    ),
                    SizedBox(width: 8.w,),
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          HissTextWidget(
                            textContent: userNameStar(aMyName.getData()),
                            textSize: 14.sp,
                            textColor: "#FFFFFF".toColor(),
                            fontWeight: FontWeight.w900,
                          ),
                          SizedBox(height: 4.h,),
                          HissTextWidget(textContent: "Level:${aLevel.getData()}", textSize: 12.sp, textColor: "#F9C347".toColor(),fontWeight: FontWeight.bold,),
                        ],
                      ),
                    ),
                    HissTextWidget(
