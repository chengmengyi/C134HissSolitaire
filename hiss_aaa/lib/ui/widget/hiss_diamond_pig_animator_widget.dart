...
class HissDiamondPigAnimatorWidget extends HissRootStateful{
  @override
  State<StatefulWidget> createState() => _HissDiamondPigAnimatorWidgetState();
}
class _HissDiamondPigAnimatorWidgetState extends HissRootStatefulState<HissDiamondPigAnimatorWidget> with TickerProviderStateMixin{
    ...
    return AnimatedBuilder(
      ...
      builder: (_, __) {
        return Positioned(
          ...
          child: HissImagesWidget(name: "icon_diamond", width: 36.w, height: 36.w),
        );
      },
    );
  }
  ...
  handleEventBusData(HissEventData data) {
    switch(data.eventCode){
      case HissEventCode.aShowDiamondPigAnimator:
