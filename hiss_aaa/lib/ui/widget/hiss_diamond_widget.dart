...
class HissDiamondWidget extends HissRootStateful{

  @override
  State<StatefulWidget> createState() => _HissDiamondWidgetState();
}

class _HissDiamondWidgetState extends HissRootStatefulState<HissDiamondWidget>{
  @override
  initContent() => Stack(
    ...
    children: [
      Container(
        ...
        child: HissTextWidget(
          textContent: "${countCurrentDiamond()}",
          textSize: 16.sp,
  ...
  handleEventBusData(HissEventData data) {
    switch(data.eventCode){
      case HissEventCode.aUpdateDiamondNum:
        setState(() { });
        break;
    }
  }
