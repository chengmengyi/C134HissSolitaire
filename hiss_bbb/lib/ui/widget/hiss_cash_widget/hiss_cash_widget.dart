...
import 'package:hiss_bbb/ui/widget/hiss_cash_widget/hiss_cash_widget_controller.dart';
...
class HissCashWidget extends HissRootWidget<HissCashWidgetController>{
  String tag;
  HissCashWidget({
    required this.tag,
});
  ...
  @override
  String controllerTag() => "HissCashWidgetController_$tag";
  
  @override
  HissCashWidgetController initGetController() => HissCashWidgetController();
  ...
  _moneyWidget()=>Positioned(
    ...
    child: Column(
      ...
      children: [
        ...
        GetBuilder<HissCashWidgetController>(
          id: "money",
          tag: controllerTag(),
  ...
  _tabWidget()=>Container(
    ...
    child: Stack(
      ...
      children: [
        ...
        Container(
          margin: EdgeInsets.only(top: 10.h),
          child: GetBuilder<HissCashWidgetController>(
            id: "tab",
            tag: controllerTag(),
            builder: (_)=>Row(
              mainAxisSize: MainAxisSize.min,
