...
import 'package:hiss_bbb/ui/dialog/super_prop_dialog/super_prop_dialog_controller.dart';
...
class SuperPropDialog extends HissRootDialog<SuperPropDialogController>{
  ...
  Widget initContent() => Column(
    ...
    children: [
      ...
      HissTextWidget(textContent: "Automatically organize 4 cards to speed up reward collection!", textSize: 16.sp, textColor: "#FFFFFF".toColor(),),
      // SizedBox(height: 8.h,),
